...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Вперёд",sPrevious:"Назад"},
sEmptyTable:"No data available in table",sInfo:"Отображено от _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Отображено от 0 до 0 из 0 записей",sInfoFiltered:"(отфильтрованно  _MAX_ записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показано _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,
...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      + "Fixed layout"
      + "</label>"
      + "<p>Активируйте фиксированный макет. Вы не можете использовать фиксированные и бокс-макеты вместе</p>"
      + "</div>"
        //Boxed layout
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
